      ...
      >
        <div className="user-event-box mrgnbym80">
          <h4 className="event-frnds-heading">
            My Friends
            <span className="abt-me-frnds-grey">({myFriends.total})</span>
          </h4>
          <div className="events-wrap-frnds friends-list">
            {myFriends.friends.map((myFriend, index) => (
              <div key={index} className="col-md-2 col-sm-2 col-xs-4">
                <div className="frnds-photo-inner">
                  <div className="frnds-face-photo-div text-center">
                    ...
                    <img src={uploadPhoto} className="frnds-face-photo-img" />
                  </div>
                  <div className="frnds-status-info-div">
                    {myFriend.is_online && (
                      <img
                        src={contactOnline}
                        className="frnds-status-img"
                        alt="friend"
                      />
                    )}
                    {!myFriend.is_online && (
                ...
                <Link to={profile({ USER_ID: myFriend._id })}>
                  <h4 className="frnds-name">
                    {myFriend.fname} {myFriend.lname}
                  </h4>
                </Link>
              </div>
            ))}
