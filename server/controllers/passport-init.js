    ...
    User.findOne({ 'email' :  email }, function(err, user) {
      ...
      if (user) {
        ...
        // save the user
		    ...
		    mailer.sendMail('support@ibouge.com', req.body.email, mailer.introSubject, mailer.introBody(newUser, 'https://aa3ceeb54482.ngrok.io/login?token=' + activationToken))
          .then(function() {
